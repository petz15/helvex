...
def get_provider_default_model(
    ...
    """
    if provider == "claude":
        from app.services.platform.providers.claude import get_claude_default_model
        return get_claude_default_model(db, api_key)
    elif provider == "openai":
        from app.services.platform.providers.openai import get_openai_default_model
        return get_openai_default_model(db, api_key)
    elif provider == "gemini":
        from app.services.platform.providers.gemini import get_gemini_default_model
        return get_gemini_default_model(db, api_key)
    elif provider == "deepseek":
        from app.services.platform.providers.deepseek import get_deepseek_default_model
        return get_deepseek_default_model(db, api_key)
    elif provider == "groq":
        from app.services.platform.providers.groq import get_groq_default_model
...
def llm_batch_create(
    ...
    *,
    ...
    if provider == "claude":
        from app.services.platform.providers.claude import claude_batch_create
        return claude_batch_create(requests, api_key=api_key)
    elif provider == "openai":
        from app.services.platform.providers.openai import openai_batch_create
        return openai_batch_create(requests, api_key=api_key)
    elif provider == "gemini":
        from app.services.platform.providers.gemini import gemini_batch_create
...
def llm_batch_iter_results(
    ...
    *,
    ...
    if provider == "claude":
        from app.services.platform.providers.claude import claude_batch_iter_results
        ...
        from app.services.platform.providers.openai import openai_batch_iter_results
        ...
        from app.services.platform.providers.gemini import gemini_batch_iter_results
