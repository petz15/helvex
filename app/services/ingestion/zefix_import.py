...
from app.services.ml._pipeline_utils import _is_control_signal_exception, _sleep_with_abort
from app.services.scoring.scoring import compute_flex_score_breakdown, get_default_scoring_config
...
def initial_collect(
    ...
    *,
    ...
    from app.services.enrichment.web_enrichment import _google_search_ready, enrich_company_website
...
def enrich_company(
    ...
    *,
    ...
    """
    from app.services.enrichment.geocoding_pipeline import geocode_and_update_company
    from app.services.ml.noga import apply_noga_classification
    ...
    if company.purpose and not company.purpose_keywords:
        try:
            from app.services.ml.cluster_pipeline import extract_keywords_incremental
    ...
    if clusters and company.tfidf_cluster is None and company.purpose:
        try:
            from app.services.ingestion.incremental_classify import classify_new_companies_inline
...
def run_zefix_detail_collect(
    ...
    *,
    ...
    from app.services.enrichment.web_enrichment import rescore_from_stored_results
